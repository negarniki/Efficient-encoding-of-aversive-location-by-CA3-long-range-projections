...
%% Load lick detection results from AVI analysis
% 
licking = nan(1,size(belt,1));
if exist([pathname 'LickData/' filename '_1_Lick.mat'],'file')
    load([pathname 'LickData/' filename '_1_Lick.mat']);
    licking(1:length(lick.binaryLick)) = lick_periods;
    disp('Lick data loaded')
end
